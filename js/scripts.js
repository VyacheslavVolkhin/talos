	...
	if (!!$('#range01').offset()) {
		$('#range01').slider({
			...
			slide: function (event, ui) {
				...
				if ($('#range01-min').val() > 189) {
					$('#range01-min').addClass('active')
				} else {
					$('#range01-min').removeClass('active')
				}
				if ($('#range01-max').val() < 1336) {
					$('#range01-max').addClass('active')
				} else {
					$('#range01-max').removeClass('active')
				}
			}
		})
		$('#range01-min').change(function() {
			if ($('#range01-min').val() > 189) {
				$('#range01-min').addClass('active')
			} else {
				$('#range01-min').removeClass('active')
	...
	if (!!$('#range02').offset()) {
		$('#range02').slider({
			...
			slide: function (event, ui) {
				...
				if ($('#range02-min').val() > 189) {
					$('#range02-min').addClass('active')
				} else {
					$('#range02-min').removeClass('active')
				}
				if ($('#range02-max').val() < 1336) {
					$('#range02-max').addClass('active')
				} else {
					$('#range02-max').removeClass('active')
				}
			}
		})
		$('#range02-min').change(function() {
			if ($('#range02-min').val() > 189) {
				$('#range02-min').addClass('active')
			} else {
				$('#range02-min').removeClass('active')
	...
	if (!!$('#range03').offset()) {
		$('#range03').slider({
			...
			slide: function (event, ui) {
				...
				if ($('#range03-min').val() > 189) {
					$('#range03-min').addClass('active')
				} else {
					$('#range03-min').removeClass('active')
				}
				if ($('#range03-max').val() < 1336) {
					$('#range03-max').addClass('active')
				} else {
					$('#range03-max').removeClass('active')
				}
			}
		})
		$('#range03-min').change(function() {
			if ($('#range03-min').val() > 189) {
				$('#range03-min').addClass('active')
			} else {
				$('#range03-min').removeClass('active')
	...
	if (!!$('#range04').offset()) {
		$('#range04').slider({
			...
			slide: function (event, ui) {
				...
				if ($('#range04-min').val() > 0.6) {
					$('#range04-min').addClass('active')
				} else {
					$('#range04-min').removeClass('active')
				}
				if ($('#range04-max').val() < 341.6) {
					$('#range04-max').addClass('active')
				} else {
					$('#range04-max').removeClass('active')
				}
			}
		})
		$('#range04-min').change(function() {
			if ($('#range04-min').val() > 0.6) {
				$('#range04-min').addClass('active')
			} else {
				$('#range04-min').removeClass('active')
	...
	if (!!$('#range05').offset()) {
		$('#range05').slider({
			...
			slide: function (event, ui) {
				...
				if ($('#range05-min').val() > 1.8) {
					$('#range05-min').addClass('active')
				} else {
					$('#range05-min').removeClass('active')
				}
				if ($('#range05-max').val() < 27.1) {
					$('#range05-max').addClass('active')
				} else {
					$('#range05-max').removeClass('active')
				}
			}
		})
		$('#range05-min').change(function() {
			if ($('#range05-min').val() > 1.8) {
				$('#range05-min').addClass('active')
			} else {
				$('#range05-min').removeClass('active')
